...
@section('content')
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('/user/images/bg_1.jpg');"
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate   text-center">
                ...
                <p class="breadcrumbs"><span class="mr-2 "><a href="#" class="text-white">Ditulis oleh
                            {{ $cerita->user->name }}</a></span>
                </p>
                <span
                    class="bg-white px-2 rounded-pill">{{ $cerita->kategori == 1? "Sains" : ($cerita->kategori == 2 ? "Sosial" : "Agama") }}</span>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 ftco-animate">
                <p align="center" class="mb-5">
                    <img src="{{ $cerita->foto !== url('/storage') ? $cerita->foto : URL::asset('/admin/img/cerita/default.jpg')}}"
                        alt="" class="img-fluid">
                </p>
                ...
                <div class="about-author d-flex p-4 bg-light">
                    <div class="bio mr-5">
                        <img src="{{ $penulis->foto !== url('/storage') ?  $penulis->foto : URL::asset('/admin/img/user/default.png') }}"
                            alt="Image placeholder"
                            style="border-radius: 75px; height: 150px; width: 150px; object-fit: fill"
                            class="img-fluid mb-4">
                    </div>
                    <div class="desc">
                        <a href="{{ route('alumni.detail', $penulis->user_id) }}">
                            <h3>{{ $penulis->user->name }}</h3>
                        </a>
