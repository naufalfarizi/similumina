    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul') }}"
                    id="judul" name="judul" placeholder="Judul cerita">
                @error('judul')
            ...
            <div class="form-group">
                ...
                <select name="kategori" class="form-control">
                    ...
                    <option value="1" holder>Sains</option>
                    <option value="2" holder>Sosial</option>
                    <option value="3" holder>Agama</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="ckeditor form-control @error('cerita') is-invalid @enderror" id="cerita"
                    name="cerita">{{ old('cerita') }}</textarea>
                @error('cerita')
                <div class="text-muted">{{ $message }}</div>
                @enderror
            </div>
