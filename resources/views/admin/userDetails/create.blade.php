...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <p>Jangan lupa juga gabung grup <a target="_blank" href="https://t.me/ikatanalumnialbinaa">telegram</a> untuk
            mengetahui informasi dari alumni lain</p>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control @error('no_hp') is-invalid @enderror" name="foto"
                            id="foto">
                        @error('foto')
                        <div class="text-muted">{{ $message }}</div>
                        @enderror
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('adrress') is-invalid @enderror" id="adrress"
                            name="adrress" rows="5">{{ old('adrress') }}</textarea>
                        @error('adrress')
                        <div class="text-muted">{{ $message }}</div>
                        @enderror
                    </div>
